...
VALUES
(1,'配置中心','p','/p/controller/main.do?moduleFlag=p',10,'system',NOW(),'system',NOW())
;
...
VALUES
(1,'部门管理','/p/controller/organization/list.do','',0,'s-1',1,'p','system',NOW(),'system',NOW()),
(2,'权限管理','/p/controller/resource/list.do','',0,'s-2',2,'p','system',NOW(),'system',NOW()),
(3,'角色管理','/p/controller/role/list.do','',0,'s-3',3,'p','system',NOW(),'system',NOW()),
(4,'帐户管理','/p/controller/user/list.do','',0,'s-4',4,'p','system',NOW(),'system',NOW())
;
